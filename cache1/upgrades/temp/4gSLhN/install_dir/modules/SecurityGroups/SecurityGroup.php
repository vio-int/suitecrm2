...
class SecurityGroup extends SecurityGroup_sugar {
    ...
    function getGroupWhere($table_name,$module,$user_id)
    {
        ...
        if($validate_license !== true) {
            //Not a currently active license so display error and lock down to just owner records
            $curr_bean = BeanFactory::getBean($module);
            return $curr_bean->getOwnerWhere($user_id);
        }
