    ...
    function getLayouts()
    {
		...
		*/
        ...
        if ( !empty ( $nodes ) )
        {
			...
			*/
			$layouts [ translate('LBL_SEARCH') ] = array ( 'name' => translate('LBL_SEARCH') , 'type' => 'Folder' , 'children' => $nodes , 'action' => "module=ModuleBuilder&action=wizard&view=search&view_module={$this->module}".$groupLayoutParams , 'imageTitle' => 'BasicSearch' , 'help' => 'searchBtn' , 'size' => '48') ;
        }
