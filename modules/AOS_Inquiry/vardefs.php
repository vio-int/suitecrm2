    ...
    'fields' => array (
        ...
        'accounts' =>
            array(
                ...
                'vname' => 'LBL_ACCOUNTS',
                'type' => 'link',
                'relationship' => 'account_aos_inquiry',
                'module' => 'Accounts',
                'bean_name' => 'Account',
                'source' => 'non-db',
            ),
        'contacts' =>
            array(
                ...
                'vname' => 'LBL_CONTACTS',
                'type' => 'link',
                'relationship' => 'contact_aos_inquiry',
                'module' => 'Contacts',
                'bean_name' => 'Contact',
                'source' => 'non-db',
            ),
        'opportunities' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'opportunity_aos_inquiry',
                'module' => 'Opportunities',
        ...
        'aos_inquiry_project' =>
            array(
                'name' => 'aos_inquiry_project',
                'vname' => 'LBL_AOS_QUOTES_PROJECT',
                'type' => 'link',
                'relationship' => 'aos_inquiry_project',
                'source' => 'non-db',
                'module' => 'Project',
            ),
        'aos_inquiry_aos_invoices' =>
            array(
                'name' => 'aos_inquiry_aos_invoices',
                'vname' => 'LBL_AOS_QUOTES_AOS_INVOICES',
                'type' => 'link',
                'relationship' => 'aos_inquiry_aos_invoices',
                'source' => 'non-db',
                'module' => 'AOS_Invoices',
            ),
        'aos_inquiry_aos_contracts' =>
            array(
                'name' => 'aos_inquiry_aos_contracts',
                'vname' => 'LBL_AOS_QUOTES_AOS_CONTRACTS',
                'type' => 'link',
                'relationship' => 'aos_inquiry_aos_contracts',
                'source' => 'non-db',
        ...
        'aos_products_quotes' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'aos_inquiry_aos_product_quotes',
        ...
        'aos_line_item_groups' =>
            array(
                ...
                'type' => 'link',
                'relationship' => 'aos_inquiry_aos_line_item_groups',
...
VardefManager::createVardef('AOS_Inquiry', 'AOS_Inquiry', array('basic','assignable','security_groups'));