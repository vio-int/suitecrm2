...
/**
 * Class AOS_InquiryViewDetail
 */
class AOS_InquiryViewDetail extends ViewDetail
{
    /**
     * @var AOS_Inquiry $bean;
     */
    public $bean;

    /**
     * AOS_InquiryViewDetail constructor.
     */
     ...
     */
    public function AOS_InquiryViewDetail()
    {
    ...
    protected function populateQuoteTemplates()
    {
        ...
        $sql = "SELECT id, name FROM aos_pdf_templates WHERE deleted=0 AND type='AOS_Inquiry' AND active = 1";
    ...
    protected function displayPopupHtml()
    {
        ...
        if ($templatesList) {
            ...
            echo $template->fetch('modules/AOS_Inquiry/templates/showPopupWithTemplates.tpl');
        } else {
            echo $template->fetch('modules/AOS_Inquiry/templates/showPopupWithOutTemplates.tpl');
        }
    }
}