...
class TargetAmountChartDashlet extends DashletGenericChart 
{
    public $target_id;
    /**
    ...
    public function displayOptions()
    {
        ...
        if ( $target != null )
            foreach ($target as $c)
                $this->_searchFields['target_id']['options'][$c->year] = $c->year;
    ...
    public function display()
    {
            ...
            $GLOBALS['app_list_strings']['roi_type_dom'],
            $this->target_id[0],null,true,true,true,$this->year);
...
EOD;
    ...
    protected function constructQuery($datay= array(),$targets=array(),$target_id = null, $cache_file_name='a_file', $refresh=false,$marketing_id='',$is_dashlet=false,$dashlet_id='') {
        ...
        // $focus->retrieve($target_id);
         ...
         $camp_query1  = "select tar.year, SUM(tar.target_amount) as target_amount , assigned_user_id from vli_target tar where tar.year='".$target_id."' AND deleted=0 GROUP BY assigned_user_id";
